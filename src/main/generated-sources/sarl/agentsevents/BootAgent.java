...
import agentsevents.PingAgent;
import agentsevents.PongAgent;
...
public class BootAgent extends Agent {
  private void $behaviorUnit$Initialize$0(final Initialize occurrence) {
    ...
    _$CAPACITY_USE$IO_SARL_CORE_LIFECYCLE$CALLER.spawn(PongAgent.class);
    ...
    _$CAPACITY_USE$IO_SARL_CORE_LIFECYCLE$CALLER_1.spawn(PingAgent.class);
