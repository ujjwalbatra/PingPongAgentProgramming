...
public class PongAgent extends Agent {
  private void $behaviorUnit$Ping$0(final Ping occurrence) {
    ...
    _$CAPACITY_USE$IO_SARL_CORE_LOGGING$CALLER.info(("Receiving Ping #" + Integer.valueOf(occurrence.index)));
    Logging _$CAPACITY_USE$IO_SARL_CORE_LOGGING$CALLER_1 = this.$castSkill(Logging.class, (this.$CAPACITY_USE$IO_SARL_CORE_LOGGING == null || this.$CAPACITY_USE$IO_SARL_CORE_LOGGING.get() == null) ? (this.$CAPACITY_USE$IO_SARL_CORE_LOGGING = this.$getSkill(Logging.class)) : this.$CAPACITY_USE$IO_SARL_CORE_LOGGING);
    _$CAPACITY_USE$IO_SARL_CORE_LOGGING$CALLER_1.info(("Sending Pong #" + Integer.valueOf(occurrence.index)));
  ...
  @Inject
  @Deprecated
  public PongAgent(final BuiltinCapacitiesProvider provider, final UUID parentID, final UUID agentID) {
